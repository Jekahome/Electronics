...
1. [ ] **Основы теории электрических цепей (ТОЭ)**
   ...
   - [ ] Основы анализа простых цепей.
     ...
     - [ ] Изучение методов расчета цепей: метод узловых потенциалов, метод контурных токов, метод наложения. 
    ...
    - [ ] Изучение частотных характеристик цепей (RC, RL, RLC-цепи), так как это важно для понимания аналоговой электроники.
   ...
   - Книга  «Основы электротехники» Чарльза Александера и Мэттью Сэддику
   - Книга «Электротехника» Эдварда Хьюза
...
6. [ ] **6. Проектирование печатных плат (PCB)**:
