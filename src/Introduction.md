...
# Ориентация неофита в Электронике
...
Задача современной электроники в основном является обработка информации. Нам нравятся устройства, ко­торые обрабатывают и передают сигналы, вы­деляя при этом очень небольшие объемы тепла, т. е. потребляют очень мало электроэнергии. Например, цифровые микросхемы, собранные на полевых транзисторах, функционирующих как переключатели, весьма экономичны. Такие электронные компоненты имеют низкое входное и очень высокое выходное сопротивление, а также близкий к нулю ток покоя. Можно сказать, что такие схемы не преобразуют, не потребляют и не передают электроэнергию. Они обрабатыва­ют только информацию.
   ...
   - [x] Основы анализа простых цепей.
    ...
    - [ ] Изучение частотных характеристик цепей:
      ...
      - [ ] RLC-цепи. 
        ...
        - [ ] Собрать радио (для практики резонансного контура) **нужен диод (BAT54,Д311,1N34A), переменный конденсатор и катушка, и их измерители**
        - [ ] Дополнить "картину" про источники тока (собрать схемы доступных источников тока)
     - [ ] [Линейные генераторы сигналов. Создают периодические сигналы (синусоидальные)](/theories_of_electrical_circuits/lessons/103.html)
...
5. [ ] **Изучение цифровой электроники и микроконтроллеров:**
   ...
   Книга: Цифровая схемотехника, основы построения, от азов к вершинам мастерства. Шустов М.А 
