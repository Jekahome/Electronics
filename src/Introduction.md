   ...
   - [x] Основы анализа простых цепей.
    ...
    - [ ] Изучение частотных характеристик цепей:
      ...
      - [ ] RLC-цепи. 
        ...
        - [ ] [RLC-фильтр](/theories_of_electrical_circuits/lessons/93.html#rlc-%D1%84%D0%B8%D0%BB%D1%8C%D1%82%D1%80)
     - [ ] Линейные генераторы сигналов. Создают периодические сигналы (синусоидальные)
     - [x] Основы цепи переменного тока

    **II** [Не линейные электрические цепи:](/theories_of_electrical_circuits/lessons/100.html)
    - [ ] Анализ цепей c диодами, транзисторами, варисторами. 
