...
![Flux RMA-223.](img/13.png "Flux RMA-223.")

Flux RMA-223 - это тип паяльного флюса (solder flux) для поверхностного монтажа (SMD) и при работе с BGA (Ball Grid Array) компонентами. RMA расшифровывается как Resin Mildly Activated, что указывает на его состав и уровень активности.

Состав: Основу флюса составляют канифоль (resin) и мягкие активаторы.

Обычно поставляется в виде пасты высокой вязкости, что облегчает его точное нанесение, особенно при работе с мелкими SMD компонентами и BGA шариками. Часто фасуется в шприцы для удобства дозирования.

Остатки: Flux RMA-223 относится к классу "no-clean" (безотмывочных) флюсов. Это означает, что остатки флюса после пайки не являются коррозионно-активными и в большинстве случаев не требуют обязательной очистки. 
